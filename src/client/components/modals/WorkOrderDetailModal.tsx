...
const WorkOrderDetailModal = ({
    ...
    const form = useForm<WorkOrderDetailView>({
    ...
    const saveChanges = async (data: WorkOrderDetailView) => {

        try {
            await service.addDetail(workOrderId, data);
    ...
    const onSubmit = (data: WorkOrderDetailView) => { 
